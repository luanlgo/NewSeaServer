...
const LEITOR = {
  ...
  flat_reduction: 'applyDamageReduction',
  ...
  damage_to_mana_pct: 'damageToMana', death_save_chance: 'deathSaveChance',
  ...
  reload_pct: 'reloadMult', cannon_range_pct: 'cannonRangeMult',
  ...
  wave_speed_pct: 'speedMult', weather_speed_pct: 'weatherResist',
  ...
  reverse_speed_pct: 'reverseSpeedMult', map_travel_pct: 'mapTravelMult',
  // CC e percepção
  ...
  gunpowder_drop_pct: 'lootMult', iron_drop_pct: 'lootMult', map_fragment_pct: 'lootMult',
  ammo_drop_pct: 'lootMult', wreck_loot_pct: 'lootMult', fishing_yield_pct: 'lootMult',
  mission_reward_pct: 'lootMult', bounty_pct: 'lootMult', trade_profit_pct: 'lootMult',
  pet_food_pct: 'lootMult', party_loot_pct: 'lootMult', bank_interest_pct: 'lootMult',
